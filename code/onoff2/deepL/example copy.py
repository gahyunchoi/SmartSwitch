...
csvdata = genfromtxt("exportdb.csv", delimiter=",", dtype=np.chararray)  # Training data
csvarray = np.array([ i[1::] for i in csvdata])
#print (csvarray)

random.seed(111)
rng = pd.date_range(start='2017-09-01', periods=144, freq='10min') #7day : 1008
